    ...
    <div className="bg-[#d9cbb7] min-h-screen flex flex-col items-center justify-center p-8">
      ...
      <div className="bg-[#9c8271] rounded-3xl shadow-2xl flex flex-col lg:flex-row w-full max-w-[1200px] p-8">
        <div className="flex-1 text-black space-y-6">
          ...
          Ready to reach out for our beauty journey?
            <br />
            <span className="text-white"> Fill in the contact form below to get a free consultation </span>
          </h2>
          <p className="text-base">
          Let us guide you towards the accomplishment of beauty to create our accomplishment as you journey along with personalized care and attentiveness. 
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            <div className="flex space-x-6">
              <div className="flex-1 flex flex-col">
                <label htmlFor="fullName" className="text-white font-bold text-sm mb-2">Full name</label>
                <input
                  type="text"
                  id="fullName"
                  name="fullName"
              ...
              <div className="flex-1 flex flex-col">
                <label htmlFor="email" className="text-white font-bold text-sm mb-2">Email</label>
                <input
                  type="email"
                  id="email"
                  name="email"
            ...
            <div className="flex space-x-6">
              <div className="flex-1 flex flex-col">
                <label htmlFor="telephone" className="text-white font-bold text-sm mb-2">Telephone</label>
                <input
                  type="tel"
                  id="telephone"
                  name="telephone"
              ...
              <div className="flex-1 flex flex-col">
                <label htmlFor="service" className="text-white font-bold text-sm mb-2">Service</label>
                <input
                  type="text"
                  id="service"
                  name="service"
            ...
            <div className="flex flex-col">
              <label htmlFor="message" className="text-white font-bold text-sm mb-2">Message</label>
              <textarea
                id="message"
                name="message"
