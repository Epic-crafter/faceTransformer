    ...
    <div className='flex flex-col md:h-auto bg-[#DED0C5]'>
      ...
      <div className="section-2 flex flex-col md:flex-row justify-center gap-5 mb-6">
        <div className='flex flex-col md:w-[20%] px-32 py-10 md:px-0 md:py-0 gap-6 relative'>
            <img src="/img/Gallery/gallery-imgs-fram/1.png" alt="" />
            <img className='absolute left-4 top-9 w-[248px] h-283 object-fill' src="/img/Gallery/fram-img/IMG_5255 1.png" alt="" />
        ...
        <img src="/img/Gallery/gallery-imgs-fram/4.png" alt="" />
        <img className='absolute w-[245px] h-283 left-[15px] top-[167px]' src="/img/Gallery/fram-img/IMG_5258 1.png" alt="" />
        ...
        <div className='flex flex-col md:w-[20%] px-32 py-10 md:px-0 md:py-0 gap-6 relative'>
        <img src="/img/Gallery/gallery-imgs-fram/3 (1).png" alt="" />
        <img className='absolute w-[245px] h-283 left-[15px] top-[32px]' src="/img/Gallery/fram-img/IMG_5302 1.png" alt="" />
            <div className="container-text img-text container-text py-3 px-6 border-1 rounded-[10px] font-semibold bg-gradient-to-b from-[#F0DDD1] via-[#FFFFFF] to-[#DFD8D4]">
        ...
        <img src="/img/Gallery/gallery-imgs-fram/2.png" alt="" />
        <img className='absolute  w-[245px] h-283 left-[13px] top-[175px]' src="/img/Gallery/fram-img/IMG_2565_Original 1.png" alt="" />
        </div>
      </div>
    </div>
  )
