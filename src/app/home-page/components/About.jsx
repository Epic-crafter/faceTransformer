...
const About = () => {
  return (
    <div className='flex md:flex-row mt-10 flex-col text-[50px] sm:text-[60px]px-6 md:p-12 md:h-auto bg-[#DED0C5]'>
      <div className="section-1 pt-20 px-2 pb-6 w-auto md:w-[50%]">
...
About Us
        ...
        <div className="text-section text-[#796355] font-semibold sm:px-1 md:mb-40 text-[16px]">
          <p>Welcome to Face Transformer, a pioneer in ensuring that beauty goes beyond the surface. We assist you to feel and look amazing and astounding through transformation and personalized aesthetic treatments. With a fine blend of talented artisans and modern techniques, results are delivered to elegantly enhance your natural self while remaining in balance.</p>
          <br />
          <p>My priority at Face Transformer is always your comfort and confidence. This means you’ll enjoy a seamless, rewarding experience with us at every stage, from the first consultation to the last post-procedure after-care by caring professionals. Whether you aim for a subtle enhancement or a full transformation, we will work to get you there.</p>
          <br />
          <p>Experience individualized care, professionalism, and results that speak for itself. At Face Transformer, your journey toward eternal elegance starts now. </p>
        </div>
