...
About Us
    ...
    <div className="qualification-text-2 flex flex-wrap md:flex-nowrap justify-between items-center gap-4">
      <div className="text-1 w-full md:w-[10%] text-center">
        <img src="/img/AboutRoute/img-2.jpg" alt="" className="w-full max-w-[250px] mx-auto" />
      </div>
      <div className="text-2 w-full md:w-[90%] text-end flex flex-col items-end justify-center">
        <p>
          Fellow of Academy of General Education (FAGE) MDS - Masters of Dental
          Surgery in Oral & Maxillofacial Surgery. (Topper in Branch)
        </p>
        <p>2016</p>
      </div>
    </div>
    ...
    {/* Item 3 */}
    <div className="qualification-text-3 flex md:flex-row flex-col-reverse justify-between items-center gap-4">
      ...
      <div className="text-2 w-full md:w-[10%] text-center">
        <img src="/img/AboutRoute/img-3.jpg" alt="" className="w-full max-w-[250px] mx-auto" />
      </div>
    </div>

    {/* Item 4 */}
    <div className="qualification-text-4 flex flex-wrap md:flex-nowrap justify-between items-center gap-4">
      <div className="text-1 w-full md:w-[10%] text-center">
        <img src="/img/AboutRoute/img-4.jpg" alt="" className="w-full max-w-[250px] mx-auto" />
      </div>
      <div className="text-2 w-full md:w-[90%] text-end flex flex-col items-end justify-center">
    ...
    {/* Item 5 */}
    <div className="qualification-text-5 flex md:flex-row flex-col-reverse justify-between items-center gap-4">
      <div className="text-1 w-full md:w-[80%] flex flex-col justify-center items-start text-start">
      ...
      <div className="text-2 w-full md:w-[10%] text-center">
        <img src="/img/AboutRoute/img-5.jpg" alt="" className="w-full max-w-[250px] mx-auto" />
      </div>
    </div>

    {/* Item 6 */}
    <div className="qualification-text-6 flex flex-wrap md:flex-nowrap justify-between items-center gap-4">
      <div className="text-1 w-full md:w-[10%] text-center">
        <img src="/img/AboutRoute/img-6.jpg" alt="" className="w-full max-w-[250px] mx-auto" />
      </div>
      <div className="text-2 w-full md:w-[90%] text-end flex flex-col items-end justify-center">
        <p>Zygomatic implants-Rehabilitation for atrophic maxilla hands-on workshop</p>
        <p>2021</p>
      </div>
    </div>

    {/* Item 7 */}
    <div className="qualification-text-7 flex md:flex-row flex-col-reverse justify-between items-center gap-4">
      <div className="text-1 w-full md:w-[80%] flex flex-col justify-center items-start text-start">
        <p>Bombay - Hair Transplant, Hands-on workshop</p>
        <p>2022</p>
      </div>
      <div className="text-2 w-full md:w-[10%] text-center">
        <img src="/img/AboutRoute/img-7.jpg" alt="" className="w-full max-w-[250px] mx-auto" />
      </div>
    </div>

    {/* Item 8 */}
    <div className="qualification-text-8 flex flex-wrap md:flex-nowrap justify-between items-center gap-4">
      <div className="text-1 w-full md:w-[10%] text-center">
        <img src="/img/AboutRoute/img-8.jpg" alt="" className="w-full max-w-[250px] mx-auto" />
      </div>
      <div className="text-2 w-full md:w-[90%] text-end flex flex-col items-end justify-center">
        <p>Sao Paulo, Brazil</p>
        <p>Facial Plastic Surgery Cadaveric Lab workshop</p>
        <p>2022</p>
      </div>
    </div>
  </div>
