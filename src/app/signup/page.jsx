...
const Login = () => {
  return (
    <div className='bg-[#DED0C5] flex flex-col justify-center items-center'>
      <div className='py-12'>
        <h1 className='font-bigerside-expanded uppercase font-[900] md:text-[70px] text-[50px] text-white mt-10'>SignUp</h1>
        ...
        <div className='relative'>
            <input type="text" placeholder='Your Name' className='bg-transparent focus:outline-none focus:placeholder-transparent placeholder-[#372E27] font-[700]'/>
